...
#define IIC_SCL_1()  GPIO_SetBits(SCL_PORT_IIC, IIC_SCL_PIN)		/* SCL = 1 */
#define IIC_SCL_0()  GPIO_ResetBits(SCL_PORT_IIC, IIC_SCL_PIN)		/* SCL = 0 */

#define IIC_SDA_1()  GPIO_SetBits(SDA_PORT_IIC, IIC_SDA_PIN)		/* SDA = 1 */
#define IIC_SDA_0()  GPIO_ResetBits(SDA_PORT_IIC, IIC_SDA_PIN)		/* SDA = 0 */

#define IIC_SDA_READ()  GPIO_ReadInputDataBit(SDA_PORT_IIC, IIC_SDA_PIN)	/* 读SDA口线状态 */
...
void IIC_GPIO_Init(void)
{
    ...
    GPIO_Init(SCL_PORT_IIC, &GPIO_InitStructure);
	
	GPIO_InitStructure.GPIO_Pin = IIC_SDA_PIN;
//    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
//    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_OD;  	/* 开漏输出 */
    GPIO_Init(SDA_PORT_IIC, &GPIO_InitStructure);
